...
paypal.Button.render({
    ...
    payment: function (data, actions) {
        var nombre_ofer = $('#nombre').text();
        var descripcion = $('#descripcion').text();
        // var idoferta = $('#oferta').val();
        ...
        console.log("precio: " + precio + "cantidad: " + cantidad + "Nombre: " + nombre_ofer + "Descripcion: " + descripcion);
      ...
      onAuthorize: function(data, actions) {
        ...
        var cantidad = parseInt(document.getElementById('cantidadper').innerHTML);
            ...
            $.ajax({
                type: 'POST',
                data: JSON.stringify(reservaof),
                contentType: 'application/json',
                url: 'http://localhost:3000/pagoo_reserva',						
